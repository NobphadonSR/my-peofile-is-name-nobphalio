...
const Navbar = () => {
  ...
  return (
    <nav className="bg-black/50 backdrop-blur-sm p-4 sticky top-0 z-50 transition-all duration-300">
      <div className="container mx-auto flex justify-between items-center">
        <Link href="/" className="text-primary text-xl md:text-2xl font-bold hover:scale-105 transition-transform">
          Nobphanolio
        </Link>
        ...
        <div 
          ...
          } fixed top-[64px] right-0 h-screen w-64 bg-black/90 backdrop-blur-sm transform transition-all duration-300 ease-in-out md:hidden`}
        >
